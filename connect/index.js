...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: butff, mimetype:"audio/mp4", ptt:true, contextInfo: { mentionedJid: [num] }})
    ...
    xcaa.sendButton5Msg = (jid, text = '' , footer = '', but = [], quoted = '', options = {}) => {
    ...
    xcaa.sendMessage(jid, templateMessage {quoted, ...options})
    }
