...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: butff, ptt:true, contextInfo: { mentionedJid: [num], mimetype: "audio/mp4", forwardingScore: 999999, isForwarded: true, externalAdReply: {title: teks1, body: `${ddate}`, mediaType: "2", thumbnail: bufft, mediaUrl: global.linkgc}}})
