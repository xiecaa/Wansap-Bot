...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: butff, mimetype:"audio/mp4", ptt:true, contextInfo: { mentionedJid: [num] } }, {quoted: key : {participant : '0@s.whatsapp.net'},message: {orderMessage: {itemCount : 1,status: 1,surface : 1,message: `Welcome @${num.split("@")[0]} 👋`,orderTitle: `To ${metadata.subject}`,thumbnail: ppuser,sellerJid: '0@s.whatsapp.net'}}})
