...
async function startR(){
    ...
    xcaa.sendMessage(anu.id, {audio: butff, mimetype:"audio/mp4", ptt:true, duration: 99990000, contextInfo:{externalAdReply:{title: `Welcome @${num.split('@')[0]}`, body: `To ${metadata.subject} 👋`, thumbnail: ppuser, mediaType:2, mediaUrl: "https://wa.me/6283818221226", sourceUrl: "https://wa.me/6283818221226"}}})
