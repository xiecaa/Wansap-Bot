...
module.exports = xcaa = async(xcaa, m, chatUpdate, store) => {
  ...
  const ftroli = {key: {fromMe: false, participant: "6283818221226:0@s.whatsapp.net", remoteJid: "120363024895918839@g.us"}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: global.thumb2, surface: 200, message: global.packname, orderTitle: global.ownerName, sellerJid: "0@s.whatsapp.net"}}}
...
`
  ...
  xcaa.sendMessage(from, templateMessage)
  }
  break
...
case 'ytmp3': {
  ...
  xcaa.sendMessage(m.chat, { audio: { url: data[1].url }, mimetype: 'audio/mp3'}, { quoted: m })
  })
  } catch (err) {
  m.reply(mess.error)
  }
