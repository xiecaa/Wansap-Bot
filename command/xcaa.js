...
case 'igdl': case 'instagram': case 'ig': {
  ...
  if (i.extension === "mp4") {
  xcaa.sendMessage(from, { video: { url: i.result.link }, mimetype: "video/mp4", caption: global.mess.sukses}, {quoted: m})
  } else if (i.extension === "jpg") {
  xcaa.sendMessage(from, { image: { url: i.result.link }, caption: global.mess.sukses}, {quoted: m})
  }
  }
  })
  }
