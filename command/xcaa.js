...
let _limit = JSON.parse(fs.readFileSync('../storage/user/limit'));
let _buruan = JSON.parse(fs.readFileSync('../storage/user/hasil_buruan'));
let _darahOrg = JSON.parse(fs.readFileSync('../storage/user/darah'))
